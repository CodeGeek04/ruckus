...
export const QUESTION_BANK: Question[] = [
  ...
  { id: 'ch-gurgaon-s1', family: 'chaos', tone: 'spicy', template: '{X} still can\'t find whose DLF sector address exists.' },
  ...
  { id: 'tr-gurgaon-s0', family: 'trust', tone: 'spicy', template: 'If your cab claim got flagged for fraud, {X} would vouch for you first.' },
  { id: 'tr-gurgaon-s1', family: 'trust', tone: 'spicy', template: 'Stuck at the office during Gurgaon flooding, {X} actually comes to get you.' },
  { id: 'tr-gurgaon-s2', family: 'trust', tone: 'spicy', template: 'Whose camera-off standup excuse would {X} always cover for.' },
  { id: 'tr-gurgaon-s3', family: 'trust', tone: 'spicy', template: 'Lost somewhere in a DLF sector with no address, {X} is who you call.' },
  { id: 'tr-gurgaon-s4', family: 'trust', tone: 'spicy', template: 'During appraisal season, {X} is the one who tells you the truth first.' },
  { id: 'tr-gurgaon-s5', family: 'trust', tone: 'spicy', template: 'At 2am in Cyber Hub with no cab, {X} is the one who stays.' },
  ...
  { id: 'ch-delhi-s1', family: 'chaos', tone: 'spicy', template: '{X} definitely got scammed bargaining and still thinks they won.' },
  { id: 'ch-delhi-s2', family: 'chaos', tone: 'spicy', template: 'Which friend convinced {X} the Blue Line metro was a shortcut?' },
  { id: 'ch-delhi-s3', family: 'chaos', tone: 'spicy', template: 'At the farmhouse party, {X} started the fight nobody remembers.' },
  { id: 'ch-delhi-s4', family: 'chaos', tone: 'spicy', template: 'Who dragged {X} to Old Delhi at midnight for one paratha?' },
  { id: 'ch-delhi-s5', family: 'chaos', tone: 'spicy', template: '{X} showed up to a wedding without knowing whose it was.' },
  { id: 'tr-delhi-s0', family: 'trust', tone: 'spicy', template: 'If your metro card runs out at Rajiv Chowk, {X} pays without hesitation.' },
  ...
  { id: 'tr-delhi-s2', family: 'trust', tone: 'spicy', template: 'Stuck at Old Delhi at midnight, {X} is the one who comes to get you.' },
  { id: 'tr-delhi-s3', family: 'trust', tone: 'spicy', template: 'During Delhi smog season, {X} actually shares their air purifier.' },
  { id: 'tr-delhi-s4', family: 'trust', tone: 'spicy', template: 'At a farmhouse party, {X} is who you trust to drive everyone home safe.' },
  ...
  { id: 'ch-bangalore-s0', family: 'chaos', tone: 'spicy', template: '{X} would survive a three hour Silk Board commute without losing it.' },
  { id: 'ch-bangalore-s1', family: 'chaos', tone: 'spicy', template: '{X} is one bad PG landlord away from a total meltdown.' },
  { id: 'ch-bangalore-s2', family: 'chaos', tone: 'spicy', template: '{X} is most likely to hit a pothole and blame HSR Layout.' },
